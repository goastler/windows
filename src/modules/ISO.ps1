...
function New-IsoFromDirectory {
    ...
    Invoke-CommandWithExitCode -Command $OscdimgPath -Arguments $arguments -Description "Create ISO with oscdimg" -WorkingDirectory (Get-Location) -InheritedIndent $InheritedIndent
